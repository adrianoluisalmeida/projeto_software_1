...
<div class="col mt-5">
    ...
    <div class="col-md-12 mt-3">
        <h3>Meus Últimos Pedidos de Ajuda <a href="${pageContext.request.contextPath}/requests/create" class="btn btn-pink btn-sm float-right">Novo pedido</a></h3>
    </div>
    ...
    <div class="col-md-12 mt-3 pr-4">
        <a href="${pageContext.request.contextPath}/requests/my" class="float-right">Ver todas as minhas solicitações</a>
    </div>
