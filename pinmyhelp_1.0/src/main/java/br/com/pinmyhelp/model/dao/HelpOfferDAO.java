...
ALTER TABLE help_offer ADD COLUMN offer_observation TEXT after offer_status;
...
public class HelpOfferDAO extends AbstractDAO<HelpOffer> {
    ...
    public HelpOfferDAO() {
        setCreateSql("INSERT INTO help_offer(offer_status, offer_observation, solicitation_id,voluntary_id) VALUES(?, ?, ?, ?)");
